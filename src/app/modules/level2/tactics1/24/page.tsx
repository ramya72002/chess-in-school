  ...
  useEffect(() => {
    ...
    const handleNextClick = async () => {
      ...
      try {
        ...
        router.push('/modules/level2/tactics1/25'); // Redirect to the M2 page
      } catch (error) {
        console.error('API Error:', error);
      }
    }; const handlePreviousClick = () => {
      router.push('/modules/level2/tactics1/23'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
