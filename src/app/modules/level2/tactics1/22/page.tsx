...
const M1: React.FC = () => {
  ...
  const puzzles = [
    ...
    { title: "Forks and Double Attacks - Part 2", level: "Knight", category: "Middlegame", dateAndtime: "2024-08-21T13:58", total_puz_count: 9, statusFlag: "Not Started" },
  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level2/tactics1/23'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level2/tactics1/21'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      ...
      <h3>2.2 Forks and Double Attacks</h3>
