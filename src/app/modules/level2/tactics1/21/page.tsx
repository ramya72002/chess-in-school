...
const M1: React.FC = () => {
  ...
  const puzzles = [
    { title: "Pins and Skewers - Part 1", level: "Knight", category: "Middlegame", dateAndtime: "2024-08-21T21:45", total_puz_count: 9, statusFlag: "Not Started" },
    { title: "Pins and Skewers - Part 2", level: "Knight", category: "Middlegame", dateAndtime: "2024-08-21T21:47", total_puz_count: 9, statusFlag: "Not Started" },
    { title: "Pins and Skewers - Part 3", level: "Knight", category: "Middlegame", dateAndtime: "2024-08-21T21:49", total_puz_count: 9, statusFlag: "Not Started" }
  ];
  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level2/tactics1/22'); // Redirect to the M2 page
} catch (error) {
    ...
    const handlePreviousClick = () => {
      ...
      router.push('/modules/level2/chessOpening/13'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>2.1 Pins And Skewers</ h3>
