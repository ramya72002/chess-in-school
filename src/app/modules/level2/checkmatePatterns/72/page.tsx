  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level2/checkmatePatterns/73'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level2/checkmatePatterns/71'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>7.2 Introduction</h3>
