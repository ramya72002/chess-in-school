...
const M1: React.FC = () => {
  ...
  useEffect(() => {
      ...
      const requestData = {
        ...
        if (storedUserDetails && storedUserDetails.email) {
          ...
          if (response1.data.success) {
            router.push('/modules/level2/gameAnalysis/81'); // Redirect to the M2 page 
    ...
    const handlePreviousClick = () => {
      ...
      router.push('/modules/level2/checkmatePatterns/77'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>7.8 Introduction</h3>
