  ...
  useEffect(() => {
    ...
    const handleNextClick = async () => {
      ...
      try {
        ...
        router.push('/modules/level2/checkmatePatterns/78'); // Redirect to the M2 page
      } catch (error) {
        console.error('API Error:', error);
      }
    }; const handlePreviousClick = () => {
      router.push('/modules/level2/checkmatePatterns/76'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      <h3>7.7 Introduction</h3>
