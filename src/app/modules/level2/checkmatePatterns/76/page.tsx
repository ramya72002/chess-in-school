  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level2/checkmatePatterns/77'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level2/checkmatePatterns/75'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>7.6 Introduction</h3>
