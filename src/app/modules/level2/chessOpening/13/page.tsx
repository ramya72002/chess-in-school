...
const M1: React.FC = () => {
  ...
  useEffect(() => {
      ...
      const requestData = {
        ...
        if (storedUserDetails && storedUserDetails.email) {
          ...
          if (response1.data.success) {
            router.push('/modules/level2/tactics1/21'); // Redirect to the M2 page
    ...
    const handlePreviousClick = () => {
      ...
      router.push('/modules/level2/chessOpening/12'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
