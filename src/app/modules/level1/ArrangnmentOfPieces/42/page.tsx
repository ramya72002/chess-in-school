  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level2/positionalCalculations/43'); // Redirect to the M2 page
} catch (error) {
    ...
    const handlePreviousClick = () => {
      ...
      router.push('/modules/level2/positionalCalculations/41'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>4.2 Introduction</h3>
