  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/specialMoves/51'); // Redirect to the M2 page
} catch (error) {
    ...
    const handlePreviousClick = () => {
      ...
      router.push('/modules/level1/ArrangnmentOfPieces/41'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
