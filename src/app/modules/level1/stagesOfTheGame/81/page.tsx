  ...
  const handleNextClick = async () => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/stagesOfTheGame/82'); // Redirect to the M2 page
} catch (error) {
   ...
   const handlePreviousClick = () => {
      ...
      router.push('/modules/level1/understandingPieceExchanges/75'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
