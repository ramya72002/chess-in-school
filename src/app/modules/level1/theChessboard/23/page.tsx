  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/theChessboard/24'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level1/theChessboard/22'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      ...
      <section className="chessboard-info">
        ...
        {!showVideo ? (
          ...
          <ReactPlayer
            url="https://youtu.be/3sxXQOlorwY"
            controls
            playing
            width="100%"
            height="650px"
