  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/theChessboard/23'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level1/theChessboard/21'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      ...
      <section className="chessboard-info">
        ...
        {!showVideo ? (
          ...
          <ReactPlayer
            url="https://youtu.be/iYKsprs2yIA"
            controls
            playing
            width="100%"
            height="650px"
        ...
        <p>
  Now let us understand the alphabet and numbers that you see on the chess board.
</p><br />
