  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/theChessboard/25'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level1/theChessboard/23'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      ...
      <section className="chessboard-info">
        ...
        {!showVideo ? (
          ...
          <ReactPlayer
            url="https://youtu.be/VYy3Ip2RKhg"
            controls
            playing
            width="100%"
          />
