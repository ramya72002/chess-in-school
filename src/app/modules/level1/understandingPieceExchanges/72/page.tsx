  ...
  const handleNextClick = async () => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/understandingPieceExchanges/73'); // Redirect to the M2 page
} catch (error) {
   ...
   const handlePreviousClick = () => {
      ...
      router.push('/modules/level1/understandingPieceExchanges/71'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
