...
const M1: React.FC = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/introductionToPieces/33'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level1/introductionToPieces/31'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
  ...
  <h3>2.2 Major and Minor Pieces</h3>
  </header>
  ...
  <div className="media-container">
        {!showVideo ? (
          ...
          <ReactPlayer
            url="https://youtu.be/vku6EBp4J70"
            controls
            playing
            width="100%"
            height="650px"
