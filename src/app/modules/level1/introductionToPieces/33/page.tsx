  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/introductionToPieces/34'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level1/introductionToPieces/32'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>3.3 Understanding the ‘King’</h3>
