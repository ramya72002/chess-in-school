  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level2/tactics2/34'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level2/tactics2/32'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>3.3 Introduction</h3>
