  ...
  useEffect(() => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/introductionToPieces/32'); // Redirect to the M2 page
} catch (error) {
      ...
      router.push('/modules/level1/theChessboard/26'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
   ...
   {isLoadingPage && <Loading />}
      ...
      <div className="media-container">
        {!showVideo ? (
          ...
          <ReactPlayer
            url="https://youtu.be/vGWIQkp-63k"
            controls
            playing
            width="100%"
            height="650px"
