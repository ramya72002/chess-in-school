...
const M1: React.FC = () => {
  ...
  const handleNextClick = async () => {
    ...
    try {
      ...
      const requestData = {
        ...
        router.push('/modules/level1/introductionToPieces/38'); // Redirect to the M2 page
} catch (error) {
  ...
  const handlePreviousClick = () => {
      ...
      router.push('/modules/level1/introductionToPieces/36'); // Redirect to the previous page (adjust the path as needed)
    };
  return (
    <div className="lesson-content">
      {isLoadingPage && <Loading />}
      <h3>3.7 Understanding the ‘Pawn’</h3>
